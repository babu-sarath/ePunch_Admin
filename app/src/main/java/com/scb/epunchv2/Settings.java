...
public class Settings extends AppCompatActivity {
    ...
    public void changePwd(View view) {
        final View layout=getLayoutInflater().inflate(R.layout.change_password,null);
        EditText oldPwdEt=layout.findViewById(R.id.oldPwd);
        EditText newPwdEt=layout.findViewById(R.id.newPwd);
        ...
        builder.setCancelable(false)
                .setMessage("Change your account password")
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(oldPwd) && !TextUtils.isEmpty(newPwd)){
                    if(oldPwd.equals(newPwd)){
                        newPwdEt.setError("Enter new password");
                    }else {
                        sendPwdResetVolleyReq(oldPwd,newPwd,alertDialog,progressBar,oldPwdEt,newPwdEt,submit,cancel);
                    }
                }else {
                    if(TextUtils.isEmpty(oldPwd))
                        oldPwdEt.setError("Do not leave this empty");
                    else
                        newPwdEt.setError("Do not leave this empty");
                }
            }
        });
    ...
    private void sendPwdResetVolleyReq(String oldPwd, String newPwd, AlertDialog alertDialog, ProgressBar progressBar, EditText oldPwdEt, EditText newPwdEt, Button submit, Button cancel) {
