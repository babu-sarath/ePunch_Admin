...
import com.scb.epunchv2.Adapters.AttendanceAdaptor;
import com.scb.epunchv2.UtilsService.DateConverter;
...
public class AttendanceEmployee extends AppCompatActivity {
    ...
    TextView dateText,title;
    String startDate,endDate, Email,Name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(String.format("%s Attendance", Name));
        ...
        progressDialog=new ProgressDialog(AttendanceEmployee.this,R.style.CustomAlertDialog);
    ...
    private void getInfo() {
        String apiKey = "https://epunchapp.herokuapp.com/view/listAttendance/"+ Email;
